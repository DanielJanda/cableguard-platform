...
- **Status:** ACCEPTED FOR SOFTWARE INTEGRATION (office `.63` visual PASS). Zahrádky on-site visual commissioning pending — not a merge blocker; see `docs/operations/zahradky-onsite-commissioning-checklist.md`.
