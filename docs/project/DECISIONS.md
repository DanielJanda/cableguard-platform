...
- **Status:** Accepted (office `.63` proven **A**). **Zahrádky on-site visual PENDING** — provisional production profile remains `pyav_rtsp`+`mediamtx`; do not hard-cut over until station confirmation.
